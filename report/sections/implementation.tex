...
Augmenting with these transformations effectively increases our training data set to \numprint{985248}, we will augment the validation set as we need it as a baseline to validate against.
