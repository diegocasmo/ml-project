...
Augmenting with these transformations effectively increases our training data set by a great amount. In an 80/20 split there will be \numprint{49262} training images, when this is augmented there will be effectively \numprint{788198} images. The validation dataset is not augmented as it is needed as is for a baseline.
