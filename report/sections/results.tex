...
HSV is a different color space, here's how it's different from RGB, here's why we thought this would work, here are the results, here's why it probably didn't work.

\subsection{Data Augmentation}
We randomly rotated some images in each batch by 90 degrees. This improved our best result by TODO.